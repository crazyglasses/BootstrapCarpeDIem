...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function assertValidOutputStride(outputStride) {
        Q.assert(typeof outputStride === 'number', function () { return 'outputStride is not a number'; });
        Q.assert(VALID_OUTPUT_STRIDES.indexOf(outputStride) >= 0, function () { return "outputStride of " + outputStride + " is invalid. " +
    ...
    var MobileNet = (function () {
        function MobileNet(modelWeights, convolutionDefinitions) {
            this.PREPROCESS_DIVISOR = Pn(255.0 / 2);
            this.ONE = Pn(1.0);
        ...
        MobileNet.prototype.predict = function (input, outputStride) {
            var _this = this;
            var normalized = Ju(input.toFloat(), this.PREPROCESS_DIVISOR);
            var preprocessedInput = fl(normalized, this.ONE);
        ...
        MobileNet.prototype.conv = function (inputs, stride, blockId) {
            ...
            var a$$1 = inputs.conv2d(weights, stride, 'same');
            var b = a$$1.add(this.convBias("Conv2d_" + String(blockId)));
    ...
    function toFlattenedOneHotPartMap(partHeatmapScores) {
        ...
        return Qr(partMapFlattened, numParts);
    }
    ...
    function toMask(segmentScores, threshold) {
        return Oe(function () {
            return segmentScores.greater(Pn(threshold)).toInt();
        });
    }
    function decodePartSegmentation(segmentationMask, partHeatmapScores) {
        ...
        return Oe(function () {
            ...
            var partNumbers = Kn(0, numParts, 1, 'int32').expandDims(1);
            ...
            var partMapShiftedUpForClipping = partMap.add(Pn(1, 'int32'));
    ...
    function getInputTensorDimensions(input) {
        return input instanceof ht ? [input.shape[0], input.shape[1]] :
            [input.height, input.width];
    }
    function toInputTensor(input) {
        return input instanceof ht ? input : Ih.fromPixels(input);
    }
    function resizeAndPadTo(input, _a, flipHorizontal) {
        ...
        var resizedAndPadded = Oe(function () {
            ...
            var padded = eo(resized, [[padT, padB], [padL, padR], [0, 0]]);
            return padded;
        });
    ...
    function scaleAndCropToInputTensorShape(tensor, _a, _b, _c) {
        ...
        var _d = _c[0], padT = _d[0], padB = _d[1], _e$$1 = _c[1], padL = _e$$1[0], padR = _e$$1[1];
        return Oe(function () {
    ...
    function removePaddingAndResizeBack(resizedAndPadded, _a, _b) {
        ...
        var _e$$1 = resizedAndPadded.shape, height = _e$$1[0], width = _e$$1[1];
        var cropH = height - (padT + padB);
        var cropW = width - (padL + padR);
        return Oe(function () {
            var withPaddingRemoved = Cu(resizedAndPadded, [padT, padL, 0], [cropH, cropW, resizedAndPadded.shape[2]]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        Q.assert(typeof multiplier === 'number', function () { return "got multiplier type of " + typeof multiplier + " when it should be a " +
                            "number."; });
                        Q.assert(possibleMultipliers.indexOf(multiplier.toString()) >= 0, function () { return "invalid multiplier value of " + multiplier +
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, loadGraphModel(baseUrl + "model.json")];
                    case 1:
                        model = _a.sent();
